...
public class Utility {
	...
	{
		return obj!=null&&(!"null".equals((String)obj))?((String)obj).trim():"";
	}
	...
	public static void alert(Context context, String title, String msg)
	{
		...
		|| msg.equals("Not subscribed or validity expired! Please contact your adminstrator or support@salesbabu.com"))
			alertDialog.setMessage(msg);
    ...
    {
            return obj!=null && ((String)obj).trim().length()>0?(String)obj:"0";
    }
